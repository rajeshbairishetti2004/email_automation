    ...
    <div class="editor-toolbar">
        <div class="toolbar-group">
            ...
            <div class="toolbar-controls">
                ...
                <button type="button" class="btn-icon" onclick="loadTemplate('greeting_template_selector', 'greeting_input')" title="Load Template">📥</button>
        ...
        <div class="toolbar-group" style="flex: 2;">
            ...
            <div class="toolbar-controls">
                ...
                <button type="button" class="btn-icon" onclick="loadTemplate('intro_template_selector', 'intro_input')" title="Load Template">📥</button>
        ...
        <div class="toolbar-group">
            ...
            <div class="toolbar-controls">
                ...
                <button type="button" class="btn-icon" onclick="loadTemplate('closing_template_selector', 'closing_input')" title="Load Template">📥</button>
...
function loadTemplate(selectorId, targetInputId) {
    ...
    if (content) {
        ...
        target.dispatchEvent(new Event('blur')); // Trigger Auto-save
        showContextualFlash('success', 'Template loaded!', 'communication_flash_container');
    }
}
